        ...
        <CardContent className="space-y-4">
          <div className="text-center space-y-4">
            <p className="text-sm text-muted-foreground">
              Sign in with Discord to start tracking your maimai scores
            </p>
            <Button 
              onClick={onLogin} 
              className="w-full"
          ...
          <div className="bg-muted/50 p-3 rounded-md text-xs text-muted-foreground">
            ...
            <ul className="space-y-1 list-disc list-inside">
              <li>Track scores across International and Japan regions</li>
              <li>View historical data snapshots</li>
              <li>Import data directly from maimai DX NET</li>
