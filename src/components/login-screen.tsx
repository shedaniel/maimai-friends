        ...
        <CardContent className="space-y-4">
          <div className="text-center space-y-4">
            {!isSignupMode ? (
              ...
              <>
                <p className="text-sm text-muted-foreground">
                  Create a new account to start tracking your maimai scores
                </p>

                {!SIGNUP_ENABLED && (
                  <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 px-3 py-2 rounded-md text-sm">
                    <p className="font-medium">Signups Currently Disabled</p>
                    <p className="text-xs mt-1">We are not accepting new registrations at this time. Please check back later.</p>
                  </div>
                )}
